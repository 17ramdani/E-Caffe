...
?>
    ...
    <body>
                ...
                <div class="span6">
                  <div class="widget-box span12">
                    ...
                    <div class="widget-content">
                      ...
                      <a href="http://localhost/adp/kawanlama/entri_transaksi.php"><button class="btn btn-primary">Selanjutnya</button> </a>
                    </div>
                  </div>
                </div>
                <div class="span6">
      ...
      <div class="row-fluid">
        <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; kawanlama <a href="#">arjuntech</a> </div>
      </div>
